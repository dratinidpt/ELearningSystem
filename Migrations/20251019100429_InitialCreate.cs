    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "AdminId", "CreatedDate", "Email", "FirstName", "LastName", "PasswordHash", "Username" },
                values: new object[] { 1, new DateTime(2025, 10, 19, 18, 4, 29, 385, DateTimeKind.Local).AddTicks(9473), "admin@elearning.com", "System", "Administrator", "$2a$11$tV8dHQ1P.QeeD9XcU0zaR.NTw.32sSSwjm.Fo9NvxNoBbVR1YU1eG", "admin" });
